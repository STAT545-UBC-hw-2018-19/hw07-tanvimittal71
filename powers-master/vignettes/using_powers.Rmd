...
Power package also consists of function for Box-cox transformation. Box-cox transformation is used to normalize the data by varying \code{lambda} between -5 to 5.
